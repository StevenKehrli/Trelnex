...
public class EncryptedSqlCommandProviderExtensionsTests : SqlCommandProviderTestBase
{
    /// <summary>
    ...
    [Test]
    [Description("Tests SqlCommandProvider with an optional message and encryption to ensure data is properly encrypted and decrypted.")]
    public async Task SqlCommandProvider_OptionalMessage_WithEncryption()
    {
    ...
    [Test]
    [Description("Tests SqlCommandProvider with encryption to ensure data is properly encrypted and decrypted.")]
    public async Task SqlCommandProvider_WithEncryption()
    {
        var encryptionService = EncryptionService.Create(_encryptionSecret);
