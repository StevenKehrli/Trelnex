...
/// <summary>
/// Tests for <see cref="CosmosDataProvider"/> using dependency injection, focusing on event persistance functionality.
/// </summary>
/// <remarks>
...
public class CosmosDataProviderExtensionsEventPersistanceTests : CosmosDataProviderEventTestBase
{
    /// <summary>
    ...
    [Test]
    [Description("Tests events stored by dependency injected CosmosDataProvider do not expire.")]
    public async Task CosmosDataProviderExtensions_WithoutExpiration()
    {
