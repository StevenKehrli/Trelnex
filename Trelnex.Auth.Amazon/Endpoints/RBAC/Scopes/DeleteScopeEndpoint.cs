...
internal static class DeleteScopeEndpoint
{
    ...
    /// <param name="request">The request parameters containing the scope deletion details.</param>
    ...
    /// 2. Deleting the scope from the RBAC repository if validations pass
    ///
    ...
    public static async Task<IResult> HandleRequest(
        ...
        [AsParameters] DeleteScopeRequest request)
    {
