...
/// <summary>
/// Represents the response after granting a role to a principal for a specific resource.
/// </summary>
/// <remarks>
/// This response reflects the updated state of a principal's memberships after a role
/// has been granted. It includes the complete list of roles and scopes the principal now
...
/// </remarks>
public record GrantPrincipalMembershipResponse
{
    #region Public Properties

    /// <summary>
    /// Gets the identifier of the principal (user or service) who has been granted the role.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Gets the name of the resource for which the role has been granted.
    /// </summary>
    /// <remarks>
    ...
    /// all scopes in which the principal has roles after the grant operation, which may
    /// include both pre-existing scopes and any new scope added by the grant operation.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// This array includes all roles assigned to the principal after the grant operation,
    /// which includes both pre-existing roles and the newly granted role. This provides
