...
/// <summary>
/// Represents the response containing a principal's membership information from the RBAC system.
/// </summary>
/// <remarks>
...
public record GetPrincipalMembershipResponse
{
    ...
    /// </summary>
    /// <remarks>
    /// Scopes define authorization boundaries for role assignments. A principal may have
    /// different roles in different scopes (e.g., "dev", "test", "prod"). The scope names
    /// array represents all the authorization contexts in which this principal has roles
    ...
    /// </summary>
    /// <remarks>
    /// Roles define sets of permissions that can be performed on a resource. Common examples
    /// include "Reader", "Writer", or "Administrator". The role names array represents all
