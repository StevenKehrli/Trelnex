...
public class CreateCommandEventTests
{
    ...
    [Test]
    [Description("Tests that create commands generate proper events with correct change tracking when property is both tracked and encrypted.")]
    public async Task CreateCommandEvent_WithEncrypt()
    {
        var activityListener = new ActivityListener
        {
            Sample = (ref ActivityCreationOptions<ActivityContext> _) => ActivitySamplingResult.AllDataAndRecorded,
        ...
        var id = "f5dcdad3-7b94-451d-a469-78dafb1c50f2";
        var partitionKey = "1e268e93-6ab7-453e-b9fc-d7592ed34b5e";
