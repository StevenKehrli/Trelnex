...
public class DeleteCommandEventTests
{
    ...
    [Test]
    [Description("Tests that delete commands generate proper events with correct change tracking when property is both tracked and encrypted.")]
    public async Task DeleteCommandEvent_WithEncrypt()
    {
        var activityListener = new ActivityListener
        {
            Sample = (ref ActivityCreationOptions<ActivityContext> _) => ActivitySamplingResult.AllDataAndRecorded,
        ...
        var id = "323bfc10-59b3-4199-afa0-1928897b88f3";
        var partitionKey = "5ffaec75-c4b4-4ada-ba94-917ac30e121e";
