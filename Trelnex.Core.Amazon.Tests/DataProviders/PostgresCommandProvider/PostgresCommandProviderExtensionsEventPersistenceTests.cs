...
public class PostgresDataProviderExtensionsEventPersistenceTests : PostgresDataProviderEventTestBase
{
    /// <summary>
    ...
    public async Task PostgresDataProviderExtension_WithoutExpiration()
    {
