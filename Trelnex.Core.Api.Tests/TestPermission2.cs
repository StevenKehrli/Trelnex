...
/// It differs from <see cref="TestPermission1"/> by using a different JWT bearer scheme, audience, issuer, and required role.
/// </summary>
internal class TestPermission2 : IPermission
{
    ...
    public string GetAudience(
        IConfiguration configuration)
    {
        return "Audience.trelnex-auth-amazon-tests-authentication-2"; // Return the required audience.
    }
    ...
    public string GetScope(
        IConfiguration configuration)
    {
        return "Scope.trelnex-auth-amazon-tests-authentication-2"; // Return the required scope.
    }
    ...
    public class TestRolePolicy : IPermissionPolicy
    {
        ...
        /// </summary>
        public string[] RequiredRoles => ["test.role.2"]; // Return the required roles.
    }
